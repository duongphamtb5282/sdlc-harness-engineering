...
Load this mode when the user needs help understanding delivery artifacts, DoD results, ceremony outputs, or technical outputs produced by other agents.

## Entry Behavior

When invoked during lifecycle execution:  

1. **Read the context** — what lifecycle state, what ceremony, what's being decided
...
### BRD Translation (Inception Review)

Read `docs/requirements/BRD.md`, then:
...
### Architecture Translation (Sprint Planning)
...
Read `.sdlc-automation-agent/compliance-engineer/`, then:
...
### Release Readiness Translation

Read all DEPLOY phase outputs, then: 
