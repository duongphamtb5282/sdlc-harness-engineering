...
description: >
  ...
  commands required. 13 delivery agents, pluggable AI backends, Scrum + Kanban
...
**13 delivery agents, one orchestrator, pluggable backends.** The orchestrator routes to the right agents based on what the user actually needs. No forced full-pipeline execution for everyday tasks.
