...
|-------|------|-----------------| 
| Business context | `docs/requirements/` | User personas, feature scope, domain glossary |
...
| Test artifacts | `tests/`, `.sdlc-automation-agent/quality-engineer/` | Test coverage, integration test descriptions, test strategy |
| DevOps artifacts | `infra/`, `.github/workflows/` | CI/CD pipelines, deployment configs, environment definitions |
| SRE artifacts | `docs/runbooks/`, `.sdlc-automation-agent/platform-engineer/reliability/` | Runbooks, incident procedures, SLO definitions, DR playbooks |
...
| Artifact | Path |
|----------|------|
| Content inventory | `.sdlc-automation-agent/technical-writer/content-inventory.md` |
| Writing notes and style decisions | `.sdlc-automation-agent/technical-writer/writing-notes.md` |
...
- Documentation plan is prioritized and resolved (approved by user in Controlled mode, auto-approved in Autonomous)
