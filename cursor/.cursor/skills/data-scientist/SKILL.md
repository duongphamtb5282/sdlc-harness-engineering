...
name: data-scientist
description: >
  [sdlc-automation-agent internal] Optimizes AI/ML/LLM usage when you need
...
| `.sdlc-automation-agent/product-manager/` | Degraded | Business context, success criteria, user personas |
...
```
.sdlc-automation-agent/data-scientist/
