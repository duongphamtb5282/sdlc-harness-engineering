...
**Integration review (mode-aware):** Autonomous — proceed immediately, report metrics. Controlled — present integration patterns for detailed review via AskUserQuestion. 
