...
|-------|------|-----------------|
| Tech stack (machine) | `docs/architecture/tech-stack.yaml` | `packs.*`, `verify.*`, language, framework |
| Tech stack (rationale) | `docs/architecture/tech-stack.md` | Selection rationale, NFR implications |
| Spec tasks | `.sdlc-automation-agent/specs/{spec-id}/tasks.md` | Next unchecked task, Verify commands | 
...
| Data models | `docs/architecture/ERD.md` | Entity relationships, field types, constraints |
...
- **Autonomous**: Auto-resolve all ambiguities with sensible defaults. Report choices in implementation plan. Do NOT ask.
- **Controlled**: Use AskUserQuestion for each category below:
...
- Autonomous: Write plan, proceed immediately. Report summary in output.
- Controlled: Present full Implementation Plan for detailed review. 

## Validation Loop 

Before moving to Phase 2:
- All mandatory inputs have been read and parsed
- Implementation Plan document is written to `.sdlc-automation-agent/software-engineer/implementation-plan.md`
- Plan resolved (approved by user in Controlled mode, auto-approved in Autonomous)
...
| `docs/architecture/ERD.md` | Relationships, constraints |
