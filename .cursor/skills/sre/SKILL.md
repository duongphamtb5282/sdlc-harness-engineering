...
name: sre
description: >
  [sdlc-automation-agent internal] Makes systems reliable in production —
  SLOs, monitoring, alerting, chaos engineering, incident runbooks,
  capacity planning. Routed via the sdlc-automation-agent orchestrator.
---
