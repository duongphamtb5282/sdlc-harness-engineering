...
# Security Engineer — Healthcare Mode

> **This file is loaded by the Security Engineer when the task involves healthcare, HIPAA, PHI, ePHI, or BAA requirements.** Follow these additional checks on top of the default security + compliance pipeline.
...
Healthcare mode findings are written to `.sdlc-automation-agent/security-engineer/healthcare/` with:
