...
| **Software Engineer [frontend mode]** | Framework APIs (React/Next.js/Vue), CSS features, browser compatibility, UI library versions |
| **Platform Engineer** | Docker base images, Terraform providers, CI/CD action versions, cloud CLI syntax, monitoring tool APIs (Datadog/Grafana/PagerDuty), cloud service quotas, Kubernetes versions |
| **Compliance Engineer** | CVEs, deprecated crypto, OWASP updates, auth provider changes, supply chain advisories |
| **Software Engineer [ai-ml mode]** | LLM model IDs/pricing/context windows, ML framework APIs, agent framework versions, vector DB APIs, embedding model specs, MCP/A2A protocol specs |
...
| **Quality Engineer** | Testing framework APIs, browser driver versions, CI runner environments |
...
| **Research Advisor** | Broad research — always verify factual claims about current state of technology |
