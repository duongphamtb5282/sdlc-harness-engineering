...
Constantly print progress. Never go silent. Follow the visual identity protocol at `.sdlc-automation-agent/.protocols/visual-identity.md` for all formatting.
