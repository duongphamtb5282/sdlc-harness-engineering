...
Read(".sdlc-automation-agent/solution-architect/working-notes.md")
Read(".sdlc-automation-agent/quality-engineer/test-plan.md")
Read(".sdlc-automation-agent/compliance-engineer/...")
Read(".sdlc-automation-agent/code-reviewer/review-report.md")
Read(".sdlc-automation-agent/sre/...")
Glob("services/**/*") 
Glob("frontend/**/*")
Glob("docs/**/*")
```

Also read research advisor's own context:
```  
Read(".sdlc-automation-agent/research-advisor/context/decisions.md")
Read(".sdlc-automation-agent/research-advisor/context/domain-research.md")
```
...
This file persists — future research advisor sessions can read it to maintain continuity across iterations.
