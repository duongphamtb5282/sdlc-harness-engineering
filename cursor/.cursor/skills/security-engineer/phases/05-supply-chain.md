...
npx license-checker --production --json \
  --out .sdlc-automation-agent/security-engineer/supply-chain/license-inventory.json

# Python
pip-licenses --format=json \  
  --output-file .sdlc-automation-agent/security-engineer/supply-chain/license-inventory.json  

# Go  
go-licenses report ./... 2>&1 \
  > .sdlc-automation-agent/security-engineer/supply-chain/license-inventory.txt
...
Write all outputs to `.sdlc-automation-agent/security-engineer/supply-chain/`:
