...
Write to `.sdlc-automation-agent/research-advisor/context/repo-map.md`:
...
This persists across sessions — future research advisor activations read this instead of re-scanning the codebase.
