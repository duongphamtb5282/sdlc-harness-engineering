...
description: >
  [sdlc-automation-agent internal] Builds web frontends — React/Next.js components,
...
| Workspace | `.sdlc-automation-agent/frontend-engineer/` | Analysis docs, design research, design decisions, performance budget, progress notes |
