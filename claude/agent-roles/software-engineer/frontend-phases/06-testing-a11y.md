...
Read Phase 3 component inventory from `.sdlc-automation-agent/software-engineer/frontend/docs/component-inventory.md`. Read Phase 4 pages from `frontend/app/pages/` for route coverage. Read Phase 5 design decisions from `.sdlc-automation-agent/software-engineer/frontend/docs/design-decisions.md` for visual regression context.
...
Produce `.sdlc-automation-agent/software-engineer/frontend/docs/a11y-audit.md`. 
...
Produce `frontend/lighthouserc.json` and `.sdlc-automation-agent/software-engineer/frontend/docs/performance-budget.md`.
...
Produce `.sdlc-automation-agent/software-engineer/frontend/docs/browser-support.md`.  
...
- `.sdlc-automation-agent/software-engineer/frontend/docs/a11y-audit.md`
- `.sdlc-automation-agent/software-engineer/frontend/docs/performance-budget.md` 
- `.sdlc-automation-agent/software-engineer/frontend/docs/browser-support.md`
